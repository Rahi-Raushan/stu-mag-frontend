...
const StudentDashboard = ({ user, onLogout }) => {
  ...
  const isPending = (courseId) => {
    return pendingEnrollments.some(enrollment => enrollment.course._id === courseId);
  };
      ...
      <div className="container">
        <div className="dashboard-tabs">
          ...
          <button
            ...
            className={`tab-btn ${activeTab === 'mycourses' ? 'active' : ''}`}
          >
                ...
                <div key={course._id} className="card">
                  ...
                  >
                    {isEnrolled(course._id) ? '✓ Enrolled' : 
                     isPending(course._id) ? '⏳ Pending Approval' : 'Enroll'}
                  </button>
                </div>
              ))}
            </div>
            ...
            <div className="grid">
              {pendingEnrollments.map((enrollment) => (
                <div key={enrollment._id} className="card">
                  ...
                  <span style={{ color: 'orange', fontWeight: 'bold' }}>⏳ Waiting for Approval</span>
